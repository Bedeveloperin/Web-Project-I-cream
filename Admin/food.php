...
<div class="content">
	...
	<tr align="center">
			<td class="title">Upload New Food</td><td><a href="view_food.php" style="color: red; text-decoration: none;">View All Products</a></td>
    </tr>
   ...
   <tr align="center">   
   	    ...
   	    <td> 
   	    	<select class="text" name="cat" onchange="showUser(this.value)">
   	    		<option value="kathiyawadi">Cone Ice cream</option>
   	    		<option value="rajsthani">Cup ice cream</option>
