...
<div style="width: 90%; margin: 0 auto;">
	<center><i class="fa-solid fa-cart-shopping" style="font-size: 100px;"></i> </center>
<center> <p style="font-size: 2.4em; color: red"> VIEW CART PRODUCT HERE 	</p> </center> 
	<div style="width: 90%; padding: 20px; text-align: right;">
			...
			<a href="checkout.php"><i class="fa-solid fa-cart-shopping" width="400"></i>Check Out</a> 
		</div>
	<br>
	<div>
...
INNER JOIN menu ON addcart.p_id=menu.id where addcart.u_id='$uid'");
		...
		<div style="width: 90%; padding: 20px; text-align: right;">
			<a href="checkout.php"></a>
			<a href="checkout.php"><i class="fa-solid fa-cart-shopping" width="40"></i>Check Out</a> 
		</div>
	</div>
